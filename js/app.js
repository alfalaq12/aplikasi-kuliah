...
html.style.setProperty('--f7-tabbar-link-active-color', '#009688');
html.style.setProperty('--f7-tabbar-link-inactive-color', 'white');
...
let bataswaktu = 30000;
let API = "https://api.crazycode.my.id/";
